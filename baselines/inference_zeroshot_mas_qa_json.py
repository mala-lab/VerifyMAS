...
## ANALYSIS WORKFLOW
Please follow these steps internally only:

### Step 1: Agent Summary
First, analyze and summarize what each agent has done throughout the conversation.

### Step 2: Error Analysis
For each agent identified in Step 1, carefully examine their actions against each error definition.

### Step 3: Final Judgment
Determine which agents committed errors and assign the appropriate error code(s).
